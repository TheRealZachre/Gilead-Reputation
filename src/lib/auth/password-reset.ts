...
export async function sendPasswordResetEmail(
  ...
  return sendResendEmail({
    to: email,
    subject: "Reset your Gilead Sciences Reputation password",
    html: `<p>You requested a password reset for your Gilead Sciences Reputation account.</p><p><a href="${resetUrl}">Reset your password</a></p><p>This link expires in 1 hour. If you did not request this, you can safely ignore this email.</p>`,
  });
}
